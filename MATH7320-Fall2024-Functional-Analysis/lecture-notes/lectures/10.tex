...
\marginnote{\scriptsize Zorn's Lemma to find a maximal proper open convex subset of $K$}
...
\marginnote{\scriptsize \textcolor{red}{Don't know how to proceed after}}
  ...
  % x_0$. Then by Hahn-Banach separation theorem, there is an extension $ \tilde{f}: X \to
